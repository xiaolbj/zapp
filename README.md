...
路线图第一批控件（Button、IconButton、Label、Checkbox/Switch、Slider、ScrollView/List、Dialog、Toast、NavigationBar、基础单行 TextField）均已有可运行实现。TextField 已支持 UTF-8 光标、Shift 选择、全选、复制、剪切、粘贴和选区替换；后续仍需补鼠标定位/拖选和 Android IME 组合文本。
