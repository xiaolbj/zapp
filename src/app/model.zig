...
pub const Model = struct {
    ...
    runtime_image_cache_clear_requested: bool = false,
    runtime_image_cache_clear_reason: runtime_image.ClearReason = .manual,
    last_runtime_image_cache_clear_reason: ?runtime_image.ClearReason = null,
    last_runtime_image_cache_released_count: u8 = 0,
    runtime_image_cache_budget: u8 = runtime_image.max_cache_budget,
    runtime_image_cache_budget_requested: ?u8 = null,
    last_runtime_image_budget_released_count: u8 = 0,
    memory_pressure_event_count: u32 = 0,
    last_memory_pressure_level: u32 = 0,
